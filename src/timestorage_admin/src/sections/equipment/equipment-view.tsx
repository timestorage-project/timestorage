...
export function EquipmentView() {
  ...
  const handleCreateEquipment = async (serialNo: string) => {
    try {
      ...
      await updateValue(newUuid, 'productInfo.serialNumber', serialNo);
      ...
      try {
        ...
        const mappedEquipment = allUUIDs.map(({ uuid, data }) => {
          ...
          return {
            ...
            status: 'installed', // You might want to determine this based on your data
            installationData: 'available', // You might want to determine this based on your data
